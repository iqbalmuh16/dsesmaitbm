...
<script src="<?php echo base_url(); ?>___/plugin/ckfinder/ckfinder.js"></script>
...
<div class="row col-md-12 ini_bodi">
  <div class="panel panel-danger">
    ...
    <div class="panel-body">
     ...
     <script>
 var editor = CKEDITOR.replace( 'editornya' );
 CKEDITOR.config.extraAllowedContent = 'video [*]{*}(*);source [*]{*}(*);';
CKFinder.setupCKEditor( editor );
 var editor1 = CKEDITOR.replace( 'editornya_a' );
 CKEDITOR.config.extraAllowedContent = 'video [*]{*}(*);source [*]{*}(*);';
CKFinder.setupCKEditor( editor1 );
 var editor2 = CKEDITOR.replace( 'editornya_b' );
 CKEDITOR.config.extraAllowedContent = 'video [*]{*}(*);source [*]{*}(*);';
CKFinder.setupCKEditor( editor2 );
 var editor3 = CKEDITOR.replace( 'editornya_c' );
 CKEDITOR.config.extraAllowedContent = 'video [*]{*}(*);source [*]{*}(*);';
CKFinder.setupCKEditor( editor3 );
 var editor4 = CKEDITOR.replace( 'editornya_d' );
 CKEDITOR.config.extraAllowedContent = 'video [*]{*}(*);source [*]{*}(*);';
CKFinder.setupCKEditor( editor4 );
 var editor4 = CKEDITOR.replace( 'editornya_e' );
 CKEDITOR.config.extraAllowedContent = 'video [*]{*}(*);source [*]{*}(*);';
CKFinder.setupCKEditor( editor4 );
            </script>
