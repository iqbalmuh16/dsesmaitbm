...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo base_url(); ?>___/img/smait.png">
    <style type="text/css">
        .no-js #loader {
            display: none;
        }
...
<body>
    ...
    <nav class="navbar navbar-findcond navbar-fixed-top" style="background-color: #2700C2; color: #fff;">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand"> &nbsp;<?php echo $this->config->item('nama_aplikasi') . " " . $this->config->item('versi'); ?></b></a>
            </div>
        ...
        <div class="col-md-3" id="v_jawaban">
            <div class="panel panel-default">
                <div class="panel-heading" id="nav_soal" style="overflow: auto">
                    <div class="btn btn-primary col-md-12"><i class="fa fa-home"></i> DAFTAR SOAL</div>
                </div>
