...
<body>
   ...
   <div class="" style="min-height: 450px">
      <nav class="navbar navbar-findcond navbar-fixed-top" style="background-color:#2700C2; color: #fff; min-height:80px;">
         <div class="container">
            <div class="navbar-header">
               ...
               <a class="navbar-brand"><b>APLIKASI DIGITAL SCHOOL EXAM <?php echo $this->config->item('nama_sekolah'); ?></b></a>
            </div>
               ...
               <ul class="nav navbar-nav navbar-right">
                  ...
                  <li class="dropdown">
                     ...
                     <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="<?php echo base_url(); ?>adm/logout" onclick="return confirm('ANDA YAKIN INGIN KELUAR?');">Logout</a></li>
                     </ul>
                  </li>
               </ul>
            </div>
   ...
   <div class="col-md-12 footer" style="background-color: #2700C2; color: #fff;">
      <b><?php echo $this->config->item('nama_sekolah') . " - " . $this->config->item('versi') . "<br> WAKTU SERVER: " . tjs(date('Y-m-d H:i:s'), "s") . " - WAKTU DATABASE: " . tjs($this->waktu_sql, "s"); ?>.</b>
   </div>
