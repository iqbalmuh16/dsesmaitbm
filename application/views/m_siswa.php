<div class="row col-md-12 ini_bodi">
  <div class="panel panel-success">
    ...
    <div class="panel-body">
      <a href="#" onclick="return aktifkan_semua_siswa();" class="btn btn-primary" style="margin-bottom: 10px"><i class="fa fa-users"></i> &nbsp;<b>Aktifkan Semua</b></a>
      <a href="#" onclick="return m_siswa_hs();" class="btn btn-danger" style="margin-bottom: 10px"><i class="fa fa-trash"></i> &nbsp;<b> Hapus Semua</b></a>
